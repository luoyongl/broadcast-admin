...
public class BDeviceReturnInfo implements Serializable {
    private Integer fId;

    private String fResourceCode;

    private String fTerminalVolume;
    ...
    public String getfTerminalVolume() {
        return fTerminalVolume;
    }

    public void setfTerminalVolume(String fTerminalVolume) {
        this.fTerminalVolume = fTerminalVolume == null ? null : fTerminalVolume.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        BDeviceReturnInfo other = (BDeviceReturnInfo) that;
