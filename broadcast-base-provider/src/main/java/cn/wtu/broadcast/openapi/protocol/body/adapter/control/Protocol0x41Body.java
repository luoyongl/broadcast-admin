...
/**
 * 应急大喇叭适配器控制指令----适配器证书更新指令（0x41）
 * @author Lenovo
 *
 */

public class Protocol0x41Body extends ProtocolBodyCommonInfo {

	public Protocol0x41Body() {
		protocol_type = ProtocolTypeEnum.Protocol0x41Body;
	}
